...
if __name__ == '__main__':    
    ...
    if args.GROnly:
        ...
        main(sample=args.sample, tree_config=tree_config, lens_args=lens_args, source_args=simus['GR']['source'])
        ...
        main(sample=args.sample, tree_config=tree_config, lens_args=lens_args, source_args=simus['fR']['source'])
        ...
        for gravity in ['GR','fR']:
            ...
            main(sample=args.sample, tree_config=tree_config, lens_args=lens_args, source_args=simus[gravity]['source'])
